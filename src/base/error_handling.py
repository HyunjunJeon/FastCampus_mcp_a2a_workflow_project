...
class McpConnectionError(Exception):
    ...
    def __init__(
        self, message: str, server_name: str | None = None, retry_count: int = 0
    ):
        super().__init__(message)
...
class DataQualityError(Exception):
    ...
    def __init__(
        self, message: str, data_source: str | None = None, severity: str = 'medium'
    ):
        super().__init__(message)
...
class AnalysisCalculationError(Exception):
    ...
    def __init__(
        self, message: str, method: str | None = None, input_data: Any = None
    ):
        super().__init__(message)
        self.method = method
...
class ErrorContext:
    ...
    def __enter__(self) -> "OperationTimer":
        ...
        logger.debug(
            'operation_started', operation=self.operation, **self.context
        )
        return self
