...
def create_data_collector_executor(
    config: LangGraphExecutorConfig | None = None, **agent_kwargs
    ...
    return LangGraphAgentExecutor(
        DataCollectorA2AAgent, config, **agent_kwargs
    )
...
def create_analysis_executor(
    ...
    return LangGraphAgentExecutor(AnalysisA2AAgent, config, **agent_kwargs)
...
def create_trading_executor(
    ...
    return LangGraphAgentExecutor(TradingA2AAgent, config, **agent_kwargs)
