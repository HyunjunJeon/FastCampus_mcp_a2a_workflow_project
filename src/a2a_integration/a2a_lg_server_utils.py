...
def build_request_handler(executor: AgentExecutor) -> DefaultRequestHandler:
    ...
    # TODO: [Production] MQ 기반 푸시 알림 구현 필요 - 현재 메모리 기반으로 서버 재시작 시 소실
    # TODO: [Scalability] Redis 기반 메시지 큐 구현 필요
    ...
    return DefaultRequestHandler(
        ...
        # TODO: [Production] PostgreSQL/MongoDB 기반 영구 Task 저장소 구현 필요
        # TODO: [Recovery] 서버 재시작 시 진행 중인 Task 복구 로직 필요
...
# TODO: [Documentation] 설치 가이드 및 의존성 관리 문서화 필요
...
class A2AAgentFactory:
    ...
    def create_data_collector_agent(
        ...
        result_extractor: Callable[[dict[str, Any]], dict[str, Any] | str]
        | None = None,
